...
public class AddParameterValueEvent {
	public static KiekerRecord createRecord() {
		...
		record.setName("AddParameterValueEvent");
		record.setFqClassName("kieker.common.record.remotecontrol.AddParameterValueEvent");
	...
	public static Mapping createMapping() {
		...
		mapping.setRecordFQClassName("kieker.common.record.remotecontrol.AddParameterValueEvent");
