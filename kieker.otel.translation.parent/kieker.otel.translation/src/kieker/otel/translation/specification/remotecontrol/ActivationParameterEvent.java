...
public class ActivationParameterEvent {

	public static KiekerRecord createRecord() {
		KiekerRecord record = Util.RECORD_FACTORY.createKiekerRecord();
		record.setName("ActivationParameterEvent");
		record.setFqClassName("kieker.common.record.remotecontrol.ActivationParameterEvent");
	...
	public static Mapping createMapping() {
		...
		mapping.setRecordFQClassName("kieker.common.record.remotecontrol.ActivationParameterEvent");
