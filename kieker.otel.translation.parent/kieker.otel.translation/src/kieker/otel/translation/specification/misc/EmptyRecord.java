...
public class EmptyRecord {
	public static KiekerRecord createRecord() {
		...
		record.setName("EmptyRecord");
		record.setFqClassName("kieker.common.record.misc.EmptyRecord");
	...
	public static Mapping createMapping() {
		...
		mapping.setRecordFQClassName("kieker.common.record.misc.EmptyRecord");
