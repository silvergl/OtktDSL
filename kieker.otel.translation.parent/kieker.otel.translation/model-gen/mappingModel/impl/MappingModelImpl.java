 ...
 * </p>
 * <ul>
 *   <li>{@link mappingModel.impl.MappingModelImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MappingModelImpl extends MinimalEObjectImpl.Container implements MappingModel {
	...
	protected EClass eStaticClass() {
		return MappingModelPackage.Literals.MAPPING_MODEL;
	}
	...
	public EList<Mapping> getMappings() {
		if (mappings == null) {
			mappings = new EObjectEList<Mapping>(Mapping.class, this, MappingModelPackage.MAPPING_MODEL__MAPPINGS);
		}
		return mappings;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case MappingModelPackage.MAPPING_MODEL__MAPPINGS:
				return getMappings();
		}
